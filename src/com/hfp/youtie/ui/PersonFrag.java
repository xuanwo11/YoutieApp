...
public class PersonFrag extends BaseHomeFragment implements OnClickListener{
	...
	public static PersonFrag newInstance(){
	...
	protected void setupViews(Bundle bundle) {
		...
		mUser = MyApplication.getInstance().getCurrentComment1().getUser2();
