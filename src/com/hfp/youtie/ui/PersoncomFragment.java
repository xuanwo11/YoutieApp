...
public class PersoncomFragment extends BaseHomeFragment implements OnClickListener{

	private ImageView personalIcon;
	private TextView personalName;
	private TextView personalSign,youxiang;
	...
	public static PersoncomFragment newInstance(){
		PersoncomFragment fragment = new PersoncomFragment();
		return fragment;
	}
	...
	protected void setupViews(Bundle bundle) {
		...
		mUser = MyApplication.getInstance().getCurrentComment().getUser();
...
//				MyApplication.getInstance().setCurrentQiangYu(mQiangYus.get(position-1));
	...
	private void getCurrentUserInfo(){
		...
		updatePersonalInfo(user);
		ActivityUtil.show(mContext, "更新完成~");
		if(mIProgressControllor!=null)
		mIProgressControllor.hideActionBarProgress();
	}
