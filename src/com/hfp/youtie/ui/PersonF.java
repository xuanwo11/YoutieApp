...
import com.hfp.youtie.adapter.PersonCenterContentAdapter;
...
public class PersonF extends BaseHomeFragment implements OnClickListener{
	...
	private com.hfp.youtie.entity.User mUser;////////
	private com.hfp.youtie.entity.User user;
	private int pageNum ;
	...
	public static PersonF newInstance(){
		PersonF fragment = new PersonF();
		return fragment;
	}
	...
	protected void setupViews(Bundle bundle) {
		...
		final String u=bundle0.getString("name");
		
				if(u.equals("72ba5552e3")){
					 mUser = user;///////////////////
					//mUser = MyApplication.getInstance().getCurrentFound().getUser();			
					}
