        ...
        ImageRequest request = new ImageRequest(urls[index], new Listener<Bitmap>() {
            ...
            public void onResponse(Bitmap response) {
               // itemImage.setImageBitmap(response);   
            	...
            	Drawable mDrawable = MainActivity1.this.getResources().getDrawable(R.drawable.fenss);
                ...
                Bitmap icon = Bitmap.createBitmap(response.getWidth(),response.getHeight()+102, Bitmap.Config.ARGB_8888); //建立一个空的BItMap  
                ...
                dst = new Rect(0, hight, width,
                		response.getHeight()+102);// bmp2在目标画布中的位置
                ...
                canvas.translate(0,response.getHeight());
                layout.draw(canvas);                             
                ...
                itemImage.setOnClickListener(new View.OnClickListener() {/////////////////////////       			
        			...
        			public void onClick(View v) {
        			   ...
        			   Bundle bundle=new Bundle();
        				...
        				intent.setClass(MainActivity1.this, CommentActivity.class);  
