 ...
 */
public class Ad3 extends BA1 implements OnClickListener {
	               ...
	               // resizeImage(uri);  
	                ...
	                icon.upload(this, new UploadFileListener() {  
	    	            ...
	    	            public void onSuccess() {  
	    	                ...
	    	                lost.save(Ad3.this);	    	                
	    	                Toast.makeText(Ad3.this,"图片上传成功~",Toast.LENGTH_SHORT).show(); 
	    	                Toast.makeText(Ad3.this,"活动发表成功~",Toast.LENGTH_SHORT).show();
	    	            }  
	    	  
	    	            @Override  
	    	            public void onFailure(int arg0, String arg1) {  
	    	                Toast.makeText(Ad3.this,"上传失败,请检查网络~",Toast.LENGTH_SHORT).show();  
	    	            }
