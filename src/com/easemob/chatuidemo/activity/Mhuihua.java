...
public class Mhuihua extends BaseActivity implements EMEventListener, OnClickListener {

	protected static final String TAG = "Mhuihua";
	// 未读消息textview
    ...
    private CircularImage bing,touxiang;
    RelativeLayout tong,she,bingz;
	/**
	 * 检查当前用户是否被删除
	 */
	...
	private void initView() {
		 ...
		 tong=(RelativeLayout)findViewById(R.id.btn_container_address_list);
		 she=(RelativeLayout)findViewById(R.id.btn_container_setting);
		main_bottom=(LinearLayout) findViewById(R.id.main_bottom);
		//main_bottom.setVisibility(View.GONE);///////////////////////////
		bingz=(RelativeLayout)findViewById(R.id.bingz);
		touxiang=(CircularImage)findViewById(R.id.touxiang);
		bing=(CircularImage)findViewById(R.id.bing);
			
		String avatarUrl = MyApplication.getInstance().getCurrentUser().getAvatar();
		ImageLoader.getInstance()
		.displayImage(avatarUrl, bing, 
		...
		bingz.setVisibility(View.GONE);
		bing.setVisibility(View.GONE);
	...
	public void onClick(View v) {
		...
		case R.id.touxiang:
			...
			bingz.setVisibility(View.GONE);
			bing.setVisibility(View.VISIBLE);
			break;
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					if (error == EMError.USER_REMOVED) {
						...
						if (NetUtils.hasNetwork(Mhuihua.this))
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(Mhuihua.this).equals(GroupsActivity.class.getName())) {
	...
	private void showConflictDialog() {
		...
		if (!Mhuihua.this.isFinishing()) {
			// clear up global variables
			try {
				if (conflictBuilder == null)
					conflictBuilder = new android.app.AlertDialog.Builder(Mhuihua.this);
				...
				conflictBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						conflictBuilder = null;
						finish();
						startActivity(new Intent(Mhuihua.this, LoginActivity.class));
					}
				});
		...
		if (!Mhuihua.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(Mhuihua.this);
