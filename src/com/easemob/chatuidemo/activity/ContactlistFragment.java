...
public class ContactlistFragment extends Fragment {
	...
	private List<com.easemob.chatuidemo.domain.User> contactList;
    ...
    private com.easemob.chatuidemo.domain.User toBeProcessUser;
    private String toBeProcessUsername;
    Button btn_back1;
    public RelativeLayout search_bar_view;//////////////////////////
    private ImageView sea,sea2;////////////////////
    /**
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		btn_back1=(Button)getActivity().findViewById(R.id.btn_back1);////////////////////
		sea=(ImageView)getActivity().findViewById(R.id.sea);////////////////////
		search_bar_view=(RelativeLayout) getView().findViewById(R.id.search_bar_view);
		sea2=(ImageView)getActivity().findViewById(R.id.sea2);////////
		
		//黑名单列表
		blackList = EMContactManager.getInstance().getBlackListUsernames();
		contactList = new ArrayList<com.easemob.chatuidemo.domain.User>();
		// 获取设置contactlist
		getContactList();
		//搜索框
		sea.setOnClickListener(new OnClickListener() {  
		    ...
		    public void onClick(View v) {  
		    	...
		    	sea2.setVisibility(View.VISIBLE);
		    	search_bar_view.setVisibility(View.VISIBLE);
		            }  
		        });
		sea2.setOnClickListener(new OnClickListener() {  
		    @Override  
		    public void onClick(View v) {  
		    	//getActivity().finish();////////////////////////////////// 
		    	sea.setVisibility(View.VISIBLE);
		    	sea2.setVisibility(View.GONE);
		...
		btn_back1.setOnClickListener(new OnClickListener() {  
		    ...
		    public void onClick(View v) {  
		    	//getActivity().finish();////////////////////////////////// 
		    	Intent intentpt =new Intent(getActivity(),com.easemob.chatuidemo.activity.Mhuihua.class); 		            
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (Constant.NEW_FRIENDS_USERNAME.equals(username)) {
					// 进入申请与通知页面
					com.easemob.chatuidemo.domain.User user = MyApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME);
	 ...
	 * @param toDeleteUser
	 */
	public void deleteContact(final com.easemob.chatuidemo.domain.User tobeDeleteUser) {
	...
	private void getContactList() {
		contactList.clear();
		//获取本地好友列表
		Map<String, com.easemob.chatuidemo.domain.User> users =  MyApplication.getInstance().getContactList();
		Iterator<Entry<String, com.easemob.chatuidemo.domain.User>> iterator = users.entrySet().iterator();
		while (iterator.hasNext()) {
			Entry<String, com.easemob.chatuidemo.domain.User> entry = iterator.next();
		...
		// 排序
		Collections.sort(contactList, new Comparator<com.easemob.chatuidemo.domain.User>() {

			@Override
			public int compare(com.easemob.chatuidemo.domain.User lhs, com.easemob.chatuidemo.domain.User rhs) {
	...
	public void onSaveInstanceState(Bundle outState) {
	    ...
	    if(((Mhuihua)getActivity()).isConflict&((Mshezhi)getActivity()).isConflict1){
	    	outState.putBoolean("isConflict", true);
	    	outState.putBoolean("isConflict1", true);
	    }else if(((Mhuihua)getActivity()).getCurrentAccountRemoved()&((Mshezhi)getActivity()).getCurrentAccountRemoved()){
    ...
    public void onSaveInstanceState(Bundle outState) {
		super.onSaveInstanceState(outState);
		//((Mshezhi)getActivity()).isConflict=true;
		//((Mshezhi)getActivity()).getCurrentAccountRemoved();	
		outState.putBoolean("isConflict", true);
		outState.putBoolean(Constant.ACCOUNT_REMOVED, true);
       /*if(((Mhuihua)getActivity()).isConflict){       
        	outState.putBoolean("isConflict", true);
        	
        }else if(((Mhuihua)getActivity()).getCurrentAccountRemoved()){
