...
public class Mtongxunlu extends BaseActivity implements EMEventListener {

	protected static final String TAG = "Mtongxunlu";
	// 未读消息textview
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, chatHistoryFragment)
				.add(R.id.fragment_container, contactListFragment).hide(chatHistoryFragment).show(contactListFragment)
				.commit();
		init();
	}
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (ChatActivity.activityInstance != null
					    ...
					    Toast.makeText(Mtongxunlu.this,
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					if (error == EMError.USER_REMOVED) {
						...
						if (NetUtils.hasNetwork(Mtongxunlu.this))
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(Mtongxunlu.this).equals(GroupsActivity.class.getName())) {
	...
	private void showConflictDialog() {
		...
		if (!Mtongxunlu.this.isFinishing()) {
			// clear up global variables
			try {
				if (conflictBuilder == null)
					conflictBuilder = new android.app.AlertDialog.Builder(Mtongxunlu.this);
				...
				conflictBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						conflictBuilder = null;
						finish();
						startActivity(new Intent(Mtongxunlu.this, LoginActivity.class));
					}
				});
		...
		if (!Mtongxunlu.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(Mtongxunlu.this);
