...
//	private RelativeLayout rl_switch_chatroom_leave;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		btn_back2=(Button)getActivity().findViewById(R.id.btn_back2);////////////////////
			...
			public void onSuccess() {
				getActivity().runOnUiThread(new Runnable() {
					public void run() {
						pd.dismiss();
						// 重新显示登陆页面
						((Mhuihua) getActivity()).finish();
						startActivity(new Intent(getActivity(), RegisterAndLoginActivity.class));
   ...
   /* @Override
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((Mshezhi)getActivity()).isConflict1&((Mhuihua)getActivity()).isConflict){
        	outState.putBoolean("isConflict", true);
        }else if(((Mshezhi)getActivity()).getCurrentAccountRemoved()&((Mhuihua)getActivity()).getCurrentAccountRemoved()){
    ...
    public void onSaveInstanceState(Bundle outState) {
		...
		if(((Mshezhi)getActivity()).isConflict){              	
        	outState.putBoolean("isConflict", true);
        }else if(((Mshezhi)getActivity()).getCurrentAccountRemoved()){
