...
public class Mshezhi extends BaseActivity implements EMEventListener {

	protected static final String TAG = "Mshezhi";
	// 未读消息textview
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, chatHistoryFragment)
				.add(R.id.fragment_container, settingFragment).add(R.id.fragment_container, contactListFragment).hide(chatHistoryFragment).hide(contactListFragment).show(settingFragment)
				.commit();
		init();
	}
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					if (error == EMError.USER_REMOVED) {
						...
						if (NetUtils.hasNetwork(Mshezhi.this))
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(Mshezhi.this).equals(GroupsActivity.class.getName())) {
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putBoolean("isConflict1", isConflict1);
		outState.putBoolean(Constant.ACCOUNT_REMOVED, isCurrentAccountRemoved1);	
	...
	private void showConflictDialog() {
		...
		if (!Mshezhi.this.isFinishing()) {
			// clear up global variables
			try {
				if (conflictBuilder == null)
					conflictBuilder = new android.app.AlertDialog.Builder(Mshezhi.this);
				...
				conflictBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						conflictBuilder = null;
						finish();
						startActivity(new Intent(Mshezhi.this, LoginActivity.class));
					}
				});
		...
		if (!Mshezhi.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(Mshezhi.this);
